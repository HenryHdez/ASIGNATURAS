...
% uncomment the following to show a box plot of the slopes where we can see
% the mean, quartiles, whiskers and outliers

% boxplot(dx)

% uncomment the following to show a normal probability plot

% normplot(dx)

% create the threshold, in this case the mean +/- 2.5 standard deviations,
% same as used for the above boxplot
