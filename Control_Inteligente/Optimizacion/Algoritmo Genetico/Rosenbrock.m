...
Individuos=80;
N_Var=2;
P0=random('unif',-2.048,2.048,Individuos,N_Var);
pc=0.2;
pm=0.05;
MA=P0;
Minimo=0;%Condicion de si busca maximo o minimo Si > que Cero busca minimo sino maximo
for Corridas=1:10
    for Iteracion=1:Individuos
        %Selección
        for i=1:Individuos
            fi(i,:)=double(subs(f,[x1 x2],P0(i,:)));
        end
